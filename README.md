...
![alt text](https://github.com/farhadsh1992/StampOne/blob/Farhad/docs/assets/img/fig0_architecture_comparison.jpg)
...
#### Color Histogram (ColorHisto) or  [HistoGan](https://github.com/mahmoudnafifi/HistoGAN)
