...
INFO: Helpers for running a TFLite SSD-MobileNet detector: builds the
COCO label map, packages raw interpreter output into a dict, and applies
...
def create_category_index(label_path='./DetectionLibs/Tools_ObjectDetection/coco_ssd_mobilenet/labelmap.txt'):
    """
