...
INFO:
    TFLite variant of the PRN face-reconstruction wrapper: uses a
    MobileNet box detector instead of dlib to find the face before
    regressing its 3D position map.
LAST_UPDATE:
...
from stampone.tools_detection.Tools_Face_Detection_System.predictor_tflite import PosPrediction
import stampone.tools_detection.Tools_Face_Detection_System.Face_Detection_Models as FD
