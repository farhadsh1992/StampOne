"""
PRN wrapper around PRNet (Position Map Regression Network) for 3D face
reconstruction and dense alignment; used to locate facial landmarks so the
encoded region can be cropped to and re-inserted at the right position.
Adapted from https://github.com/yfeng95/PRNet.
"""
