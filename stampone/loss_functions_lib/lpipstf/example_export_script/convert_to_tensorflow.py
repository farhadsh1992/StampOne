"""
Vendored example script from alexlee-gk/lpips-tensorflow: converts the
official PyTorch LPIPS (VGG) weights into the TF/Keras model defined in
lpips_tensorflow.py and sanity-checks it against reference image pairs.
"""
