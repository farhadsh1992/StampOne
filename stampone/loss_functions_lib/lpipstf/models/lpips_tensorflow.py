...
INFO:
    Vendored copy of alexlee-gk/lpips-tensorflow: builds the Keras VGG16
    perceptual feature extractor and learned linear layers used to
    reconstruct the LPIPS metric from exported PyTorch weights.
    -ref: https://github.com/alexlee-gk/lpips-tensorflow
...
from keras.layers import Input, Lambda, Dropout, Conv2D, Permute
