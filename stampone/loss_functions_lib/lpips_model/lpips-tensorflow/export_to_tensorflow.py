"""
Vendored copy of alexlee-gk/lpips-tensorflow: exports the official
PyTorch LPIPS model to ONNX and then to a frozen TensorFlow .pb graph
(the format loaded by Lpips_TF1 in Lpips_keras3.py).
"""
